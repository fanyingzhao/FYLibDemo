...
public class PermissionUtils {
     ...
     * @param context
     * @param permissions
     * @param req 授权码，在 onRequestPermissionsResult 调用是传入
     * @param runnable 如果授权成功，执行的代码
     */
     ...
     * 请求权限结果调用
     * @param isReq
     * @param grantResults askPermission 中的 req
     * @param okRun 如果授权成功，执行的代码
     * @param deniRun 如果授权失败，执行的代码
     */
